...
public class WordModifierNoIntact {

    public void start () throws Exception {

        Map<String, String> data = new HashMap<String, String>();
        data.put("JSON", "JOHNYYYYYYYYYYY!!!!!!!!!!!!");
        replace("C://disV5.docx", data, new FileOutputStream("C://disV5output.docx"));

    }
    public void replace(String inFile, Map<String, String> data, OutputStream out) throws Exception, IOException {
