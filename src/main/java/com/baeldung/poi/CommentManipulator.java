...
public class CommentManipulator {
    ...
    public void startManipulating() throws Exception {

        XWPFDocument document = new XWPFDocument(new FileInputStream("CreateWordWithComments.docx"));
        ...
        for (POIXMLDocumentPart.RelationPart relationPart : document.getRelationParts()) {
            ...
            if (relation.equals(XWPFRelation.COMMENT.getRelation())) {
                POIXMLDocumentPart part = relationPart.getDocumentPart(); //this is only POIXMLDocumentPart, not a high level class extending POIXMLDocumentPart
        ...
        document.write(new FileOutputStream("WordDocumentHavingComments2222.docx"));
